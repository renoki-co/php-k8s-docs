...
* [🧭 Getting Started](interacting-with-the-cluster/getting-started.md)
* [🎭 CRUD Operations](interacting-with-the-cluster/crud-operations.md)
* [📦 Import from YAML](interacting-with-the-cluster/import-from-yaml.md)
* [👀 Watching Resources](interacting-with-the-cluster/watching-resources.md)

## Resources

* [👓 Base Resource](resources/base-resource/README.md)
...
* [🧵 Configurations](resources/configurations/README.md)
...
* [📶 Networking](resources/networking/README.md)
  * [Service](resources/networking/service.md)
  * [Ingress](resources/networking/ingress.md)
* [↔ Scaling & Availability](resources/scaling-and-availability/README.md)
...
* [✨ Create classes for CRDs](advanced/create-classes-for-crds/README.md)
  * [🎇 Getting started](advanced/create-classes-for-crds/getting-started.md)
  * [🏰 Macros](advanced/create-classes-for-crds/macros.md)
  * [👀 Watchable Resources](advanced/create-classes-for-crds/watchable-resources.md)
  * [↔ Scalable Resources](advanced/create-classes-for-crds/scalable-resources.md)
  * [💊 Podable Resources](advanced/create-classes-for-crds/podable-resources.md)
  * [📄 Loggable Resources](advanced/create-classes-for-crds/loggable-resources.md)
  * [🚒 Helper Traits](advanced/create-classes-for-crds/helper-traits.md)
