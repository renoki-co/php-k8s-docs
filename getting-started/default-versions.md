...
The minimum Kubernetes version that is supported by a given package version can be found [in the project readme file, at the very top](https://github.com/renoki-co/php-k8s). 

Maintainers try as hard as possible to update the Kubernetes versions that are put into test to the latest patch as often as possible.
